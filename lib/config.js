  ...
  return {
    ...
    adapters: {
      ...
      slack: {
        ...
        allowedUserIds: arr(a.slack?.allowedUserIds),
      },
      discord: {
        ...
        allowedUserIds: arr(a.discord?.allowedUserIds),
      },
      telegram: {
        ...
        allowedUserIds: arr(a.telegram?.allowedUserIds),
      },
      mattermost: {
        ...
        allowedUserIds: arr(a.mattermost?.allowedUserIds),
      },
    },
    agent: {
